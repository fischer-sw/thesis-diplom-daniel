...
% -----------------------------------------------------------------------------
%one sided for reading and developing
\documentclass[12pt,a4paper,toc=chapterentrywithdots]{scrreprt}

%tow sided for printing
%\documentclass[12pt,a4paper,twoside,toc=chapterentrywithdots]{scrreprt}
...
\includepdf[pages=-]{pdfs/Aufgabenstellung_DA_Daniel_Fischer_sign.pdf}
...
\subfile{tex/03-model}
\subfile{tex/04-parameter_study}
\subfile{tex/05-errors_outlook}

\appendix
\subfile{tex/appendix}

% nocite is used if no bibfile is there
%\nocite{*}
